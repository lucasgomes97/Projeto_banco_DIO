...
def criar_conta() -> None:
    print('Informe os dados do clente: ')
...
def efetuar_saque() -> None:
    if len(contas) > 0:
        ...
        print('Aindda não existe contas cadastradas.')
    sleep(2)
    menu()
...
def efetuar_transferencia() -> None:
     if len(contas) > 0:
         numero_o: int = int(input('Informe o número de sua conta: '))
         ...
         if conta_o:
             ...
             if conta_d:
                ...
                conta_o.transferir(conta_d, valor)
                 ...
                 print(f'A sua conta destino com o número{numero_d} não foi encontrada.') 

         else:
             print(f'A conta informada com o número {numero_o} não foi encontrada.')
